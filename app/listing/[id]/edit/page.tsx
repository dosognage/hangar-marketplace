...
/**
 * Edit Listing page — full parity with the submit form.
 * Shows/hides sections based on property type, pre-fills all fields.
 * Saving resets status to "pending" for admin review.
 */
...
export default function EditListingPage() {
  ...
  const [propertyType, setPropertyType] = useState('hangar')
  ...
  useEffect(() => {
    async function load() {
      ...
      setPropertyType(data.property_type ?? 'hangar')
    ...
    <div style={{ maxWidth: '700px' }}>
      ...
      <form action={formAction} style={{ display: 'grid', gap: '1.25rem' }}>
        ...
        <Section title="Property Type">
          {/* Hidden input so server action always receives property_type */}
