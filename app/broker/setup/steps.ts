...
export const SETUP_STEPS: SetupStep[] = [
  {
    ...
    path:     '/broker/setup',
    title:    'Welcome',
    subtitle: 'Let\'s get you set up — about 3 minutes total.',
    required: true,
  ...
  },
  {
    ...
    title:    'Coverage',
    subtitle: 'Which airports do you primarily work? Powers your alerts and showcases your market.',
    required: false,
  ...
  },
  {
    ...
    title:    'Done',
    subtitle: 'You\'re ready to list. Let\'s go.',
    required: true,
