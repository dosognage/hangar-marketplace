...
/**
 * Apply for Broker Verification
 *
 * Logged-in users submit their license info. Admin reviews and approves/rejects.
 * Once approved, their public broker profile goes live at /broker/[id].
 */
...
export default function ApplyBrokerPage() {
    ...
    <div style={{ maxWidth: '620px' }}>
      ...
      <div style={{
        ...
        {[
          ...
          'Dedicated "Listed by broker" section visible to buyers',
          'Your listings highlighted in search results',
        ].map(item => (
