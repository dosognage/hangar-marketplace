export const post = {
  slug: 't-hangar-vs-box-hangar',
  title: 'T-Hangar vs. Box Hangar: Which Is Right for Your Aircraft?',
  description: 'T-hangars and box hangars each have real trade-offs in cost, space, and convenience. Here\'s how to decide which type of hangar fits your aircraft and budget.',
  publishedAt: '2025-02-03',
  updatedAt: '2025-02-03',
  keywords: ['t-hangar', 'box hangar', 'hangar types', 'aircraft hangar comparison', 'hangar for small plane'],
  body: `
